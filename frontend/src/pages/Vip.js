...
const VipBusDescription = () => {
  ...
  const fixedBookedSeats = [
     '03', '04', '05', '18', '19', '20', '41', '42', '46', '47','06','07','11','01','02'
  ]
  ...
  const amenitiesData = [
    ...
    { name: 'Child-friendly Features', description: 'Ensure a child-friendly experience with amenities like baby seats and entertainment', icon: '👶' },
  ...
  const handleSeatClick = (rowIndex, seatIndex) => {
    ...
    if (seat.type === 'seat') {
      ...
      let newTotalFare = updatedSelectedSeats.filter(seat => !fixedBookedSeats.includes(seat)).length * 800;
  ...
  const handleBookNow = () => {
    ...
    const bookingUrl = `/booking?busId=${encodeURIComponent('3')}&selectedSeats=${selectedSeatsParam}&date=${date}&fare=${totalFare}`;
    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-6">
          <div className="card">
            <img
              src="https://trumpwallpapers.com/wp-content/uploads/Bus-Wallpaper-17-3840x2160-1-2048x1152.jpg"
              className="card-img-top"
              alt="Happy Ride Bus"
            />
            <div className="card-body">
              <h2 className="card-title">Bus Name: VIP Luxury Travels</h2>
        ...
        <div className="col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <h4 className="card-subtitle mb-2 ">Madhurai To Kanyakumari</h4><br></br>
...
export default VipBusDescription;