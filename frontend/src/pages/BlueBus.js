...
const BlueBusBusDescription = () => {
  ...
  const fixedBookedSeats = [
    '03', '04', '05', '18', '19', '20', '41', '42', '46', '47','06','07','11','16','21','01','02'
  ]
  ...
  const amenitiesData = [
    ...
    { name: 'Personal TV Screens', description: 'Enjoy entertainment on your personal TV screen', icon: '📺' },
    { name: 'GPS Tracking', description: 'Keep track of the bus\'s location and ETA with GPS tracking', icon: '🌍' },
    { name: 'Free Drinks', description: 'Enjoy free beverages during the ride', icon: '🥤' },
  ];
  ...
  const handleSeatClick = (rowIndex, seatIndex) => {
    ...
    if (seat.type === 'seat') {
      ...
      let newTotalFare = updatedSelectedSeats.filter(seat => !fixedBookedSeats.includes(seat)).length * 900;
  ...
  const handleBookNow = () => {
    ...
    const bookingUrl = `/booking?busId=${encodeURIComponent('4')}&selectedSeats=${selectedSeatsParam}&date=${date}&fare=${totalFare}`;
    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-6">
          <div className="card">
            <img
              src="https://trumpwallpapers.com/wp-content/uploads/Bus-Wallpaper-36-1920x1200-1.jpg"
              className="card-img-top"
              alt="Happy Ride Bus"
            />
            <div className="card-body">
              <h2 className="card-title">Bus Name: BlueBus Express</h2>
        ...
        <div className="col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <h4 className="card-subtitle mb-2 ">Tirupur To Kerala</h4><br></br>
...
export default BlueBusBusDescription;
